...
function typeIcon(type) {
  const m = {Consultation:'person',Surgery:'vaccines','Follow-up':'history',Lab:'science',Emergency:'emergency'};
  return m[type] || 'event';
}
...
function submitBookAppt(e) {
  ...
  renderCalendarStrip();
  filterAppointments();
  toast(`Appointment booked for ${newA.patient}!`, 'success');
}
